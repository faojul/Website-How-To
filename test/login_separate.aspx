<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login_separate.aspx.cs" Inherits="login_separate" %>
...
<body>
   ...
   <div class = "header">
    ...
    <div class="auto-style22" style="font-size: xx-large; font-style: italic; color: #008000; width: 715px;">
    
        <em><strong style="color: #009900; background-color: #FFFFFF">Log In&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="auto-style33">Don&#39;t have an account ?create <a href="Registration.aspx" >one</a>
        <br />
&nbsp;</span></strong></em></div>
    <table class="auto-style1">
        <tr>
            <td class="auto-style55" style="color: #008000">User name </td>
            <td class="auto-style66">
                <asp:TextBox ID="TextBoxUnamelogin" runat="server" Height="32px" Width="300px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxUnamelogin" Display="Dynamic" ErrorMessage="Enter your User name !!"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style55" style="color: #008000">Password </td>
            <td class="auto-style66">
                <asp:TextBox ID="TextBoxPasslogin" runat="server" Height="32px" TextMode="Password" Width="300px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxPasslogin" Display="Dynamic" ErrorMessage="Enter Password !!"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style44">&nbsp;</td>
            <td class="auto-style66">
                <asp:CheckBox ID="CheckBoxRemember" runat="server" ForeColor="#009900" style="font-style: italic" Text="Remember me" />
            </td>
            <td>
                <asp:HyperLink ID="HyperLink1" runat="server" style="font-style: italic">Forgot Password ?</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="auto-style44">&nbsp;</td>
