<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="PetAnimal.aspx.cs" Inherits="PetAnimal" %>
...
<body>
   ...
   <div class = "header">
    ...
    <h3><i>Categories: Pets and Animals <i><h3>
                ...
                <div class="middle-right-2nd row">
                  ...
                  <ul id="hp_categories">
                     <li class="cat_icon cat_artsandentertainment"><a href="ArtsEntertain.aspx">Arts and Entertainment</a></li>
                      ...
                      <li class="cat_icon cat_philosophyandreligion"><a href="PetAnimal.aspx">Philosophy and Religion</a></li>
