<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Write_Article.aspx.cs" Inherits="Write_Article"  %>
...
<body>
   ...
   <div class = "header">
    ...
    <div class="auto-styleWR">
        
        <em>Write An Article</em></div>
        <p style="font-style: italic; font-size: x-large">
            Title:</p>
        <p style="font-style: italic; font-size: x-large">
            <asp:TextBox ID="TextBoxtitle" runat="server" BackColor="#CCCCCC" Width="670px" Font-Bold="False" Font-Italic="False"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxtitle" ErrorMessage="*">*</asp:RequiredFieldValidator>
        </p>
        <p style="font-style: italic; font-size: x-large">
            Article:</p>
        <asp:TextBox ID="TextBoxArticle" runat="server" BackColor="#CCCCCC" Height="450px" OnTextChanged="TextBox2_TextChanged" Rows="20" style="margin-right: 0px" TextMode="MultiLine" Width="679px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxArticle" ErrorMessage="*">*</asp:RequiredFieldValidator>
        <p>
           
            <asp:Button ID="Button1" runat="server" style="font-style: italic" Text="Submit" Width="143px" OnClick="Button1_Click" />
        </p>
    </asp:Panel>

    <asp:Panel ID="Panel2" runat="server">
    
               <p>you are not logged in. For login <a href="login_separate.aspx"> Click here</a>
                        </asp:Panel>       
</div>
