<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showarticle.aspx.cs" Inherits="showarticle" %>
...
<body>
   ...
   <div class = "header">
    ...
    &nbsp;<asp:TextBox ID="txtCity" CssClass ="ta" runat="server"></asp:TextBox>
        ...
        </strong></em><span class="auto-style77"><em><strong>List of Articles:</strong></em></span><br />
        <br />
        <asp:gridview id="GridView1" runat="server" autogeneratecolumns="False" CellPadding="4" EnableModelValidation="True" Width="729px" GridLines="None" ForeColor="#333333">
            <AlternatingRowStyle BackColor="White" />
    <Columns>
        
        <asp:TemplateField HeaderText="No" ItemStyle-Width="5%" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="5%"></ItemStyle>
        ...
        <asp:BoundField DataField="Title" HeaderText="  Article Name" ItemStyle-Width="95%" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Center">
                ...
                <div class="middle-right col-sm-4">
                  <div class="middle-right-first row">
                    <div class="Random article col-md-6">
                        <a <Button class="btn btn-default" href="showarticle.aspx" role="button">Random Article</Button></a>       </div>
                    <div class="Write article col-md-6">
                        <a <Button class="btn btn-default" href="Write_Article.aspx" role="button">Write An Article</Button> </a>
                    </div>
                </div>
